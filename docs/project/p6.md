...
- Trigger AWS Amplify to redeploy the frontend. 
...
You should create a [Github workflow](https://docs.github.com/en/actions/writing-workflows) named deploy-aws-lambda.yml that takes the follow steps:
...
You should create a Github workflow named deploy-aws-amplify.yml that takes the following steps:
...
Please turn in a single document that contains these parts:  
  ...
  1. Deploy your app to AWS Amplify and Lambda. Keep your app deployed until the instructors let you know that they've checked this part out.
     1. Provide a link to your Amplify frontend deployment.
  ...
  1. Provide a Git repository link to your deploy-aws-amplify.yml file.
