...
Write a 500-word (i.e., one-page) reflection on:
  ...
  2. What was wrong with what the LLM generated? What were you able to fix it easily? What problems were more difficult to fix?  
  3. How did you validate that the implementation was complete and correct? Did you use the LLM to help? 
  4. How did you test the functionality of the implementation? Explain the steps you took and why you did them.
